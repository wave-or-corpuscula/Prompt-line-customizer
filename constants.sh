...
#     ["D"]="The format value is passed to the strftime function. The result of the function execution is substituted into the prompt string. The curly brackets are mandatory."
